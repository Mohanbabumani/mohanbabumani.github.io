document.addEventListener('DOMContentLoaded', () => {
    ...
    const fundamentalBtn = document.getElementById('start-fundamental-btn');
    const intermediateBtn = document.getElementById('start-intermediate-btn');
    const advancedBtn = document.getElementById('start-advanced-btn');
    ...
    fundamentalBtn.addEventListener('click', () => startQuiz('fundamental'));
    intermediateBtn.addEventListener('click', () => startQuiz('intermediate'));
    advancedBtn.addEventListener('click', () => startQuiz('advanced'));
    ...
    // Make the "Try Again" button in the results screen work
    const resultsScreen = document.getElementById('quiz-results-screen');
    const tryAgainBtn = resultsScreen.querySelector('.quiz-btn');
    tryAgainBtn.addEventListener('click', resetQuiz);

}); // End of DOMContentLoaded

// These modal functions need to be in the global scope to work with the inline onclick attributes
